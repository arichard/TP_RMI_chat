 ...
 *
 */
public class Chat_client extends UnicastRemoteObject implements ClientInterface{
	...
	public static void main(String[] args) {
		...
		try {
            ...
            System.out.println("Le client de chat a ete enregistre " + "dans le serveur de nom.");
